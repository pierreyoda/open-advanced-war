...
class Stroke : public sf::Drawable
{
	...
	private:
		...
		float						max_lenght;			///< Maximum lenght the stroke can have
		float						min_segment_lenght; ///< Minimum lenght between each segments
		...
		// Texture
		sf::ResourcePtr<sf::Image>	image;				///< Image used in Textured mode
		...
		// Lenght
		bool						is_lenght_compiled;	///< Flag for lengh computation
		float						lenght;				///< Total lenght of the stroke
		...
		/// The function will compile the stroke and its lenght if needed.
		///
		...
		///
		////////////////////////////////////////////////////////////
		void DrawSolid(sf::RenderTarget& target, sf::Renderer& renderer) const;
		...
		///
		////////////////////////////////////////////////////////////
		void DrawSolidBloc(sf::RenderTarget & target, sf::Renderer & renderer, unsigned int current_joint, unsigned int previous_joint) const;
		////////////////////////////////////////////////////////////
		/// \brief Draw the object to a render target
		///
		...
		///
		////////////////////////////////////////////////////////////
		void DrawTexture(sf::RenderTarget & target, sf::Renderer & renderer) const;
		...
		///
		////////////////////////////////////////////////////////////
		void DrawTexturedBloc(sf::RenderTarget & target, sf::Renderer & renderer, const sf::Vector2f & TopLeft, const sf::Vector2f & TopRight, const sf::Vector2f & CenterLeft, const sf::Vector2f & CenterRight, const sf::Vector2f & BottomLeft, const sf::Vector2f & BottomRight, const sf::FloatRect & TexCoords) const;
		...
		///
		////////////////////////////////////////////////////////////
		void DrawMonochrome(sf::RenderTarget& target, sf::Renderer& renderer) const;
		...
		///
		////////////////////////////////////////////////////////////
		void DrawMonochromeBloc(sf::RenderTarget & target, sf::Renderer & renderer, unsigned int current_joint, unsigned int previous_joint) const;
		...
		///
		////////////////////////////////////////////////////////////
		void DrawWireframe(sf::RenderTarget& target, sf::Renderer& renderer) const;
		...
		////////////////////////////////////////////////////////////
		/// \brief Compute the lenght
		///
		/// This function precomputes the total lenght of the stroke,
		...
		///					meaning the lenght of the joint divised by
		///					the total lenght. (Its position on the stroke.)
		...
		////////////////////////////////////////////////////////////
		/// \brief Vector from an angle and lenght
		///
		/// \param angle The angle of the vector
		/// \param lenght The lenght of the vector
		///
		/// \return	The desired vector
		///
		////////////////////////////////////////////////////////////
		inline sf::Vector2f ToVector(float angle, float lenght);
	...
	public:
		...
		////////////////////////////////////////////////////////////
		/// \brief Get the maximum lenght the stroke can have
		///
		/// \return	Maximum lenght of the stroke, in pixels
		///
		/// \see SetMaxLenght
		///
		////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////
		/// \brief Get the minimum lenght between each joint
		///
		/// \return	Minimum lenght, in pixels
		///
		/// \see SetMinSegmentLenght
		///
		////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////
		/// \brief Get total lenght of the stroke
		///
		/// \return Total lenght
		///
		////////////////////////////////////////////////////////////
		...
		/// infinitely growing. It is a way to constraint the lenght
		/// of a stroke.
		///
		/// Default value : 0
		///
		...
		///
		/// \see GetMaxJoints, SetMaxJoints, SetMaxLenght, SetJointLifetime
		///
		////////////////////////////////////////////////////////////
		void SetMaxJoints(unsigned int max_joints);

		////////////////////////////////////////////////////////////
		/// \brief Set the maximum lenght the stroke can have
		///
		/// Stroke don't have limits in lenght. This function allow
		/// you to set a limit to the lenght. The lenght is basically
		/// the sum of the distances between each joints, not the distance
		/// between the first and last joint.
		/// If the lenght of the stroke became too long when adding new joints
		/// with \a AddJoint function, the \ Calculate function will remove
		/// the last joints of the list until the lenght get back smaller than
		/// the maximum lenght.
		/// A maximum lenght of 0 let the stroke grow infinitely.
		///
		/// Warning : if you want to use a dynamic stroke, be sure to
		/// set a maximum value to at least one of the following functions:
		/// - SetMaxJoints
		...
		/// Default value : 0
		///
		///	\param max_lenght The maximum lenght the stroke can have, in pixels
		///
		/// \see GetMaxLenght, SetMaxJoints, SetMaxLenght, SetJointLifetime
		///
		////////////////////////////////////////////////////////////
		void SetMaxLenght(float max_lenght);

		////////////////////////////////////////////////////////////
		/// \brief Set the minimum lenght between each joint
		///
		/// Having too few joints give to your stroke a sad polygonal look,
		/// but too much can be a threat to your program performances.
		/// The minimum lenght ensure a new joint placed with the /a AddJoint
		/// function will have a minimum lenght with the previous one to
		...
		/// A minimum lenght of 0 allow ANY new joints to be added.
		///
		/// Default value : 0
		///
		///	\param min_segment_lenght The minimum lenght between each joint, in pixels
		///
		/// \see GetMinSegmentLenght
		///
		////////////////////////////////////////////////////////////
		void SetMinSegmentLenght(float min_segment_lenght);
		...
		///
		////////////////////////////////////////////////////////////
		void SetImage(const sf::Image & image, bool adjust_to_new_size = false);
		...
		/// maximum lenght, maximum joint number and joint lifetime
		/// parameters.
		///
