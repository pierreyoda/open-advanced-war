...
anim = db.Anim("base_alone", "sea.png") anim:addFrame(0, 0)
sea:addAnim(anim)
anim = db.Anim("base_right", "sea.png") anim:addFrame(80, 0)
anim2 = db.Anim("base_up", "sea.png") anim2:addFrame(80, 21)
anim3 = db.Anim("base_inter4", "sea.png") anim3:addFrame(21, 21)
sea:addAnim(anim):addAnim(anim2):addAnim(anim3)]]
