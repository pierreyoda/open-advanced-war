...
hq:setResistance(20)
anim:clear():setImage("hq.png"):addFrame(0, 20) hq:addAnim(anim, "Orange Star")
anim:clear():addFrame(20, 20) hq:addAnim(anim, "Blue Moon")
anim:clear():addFrame(40, 20) hq:addAnim(anim, "Green Earth")
anim:clear():addFrame(60, 20) hq:addAnim(anim, "Yellow Comet")
